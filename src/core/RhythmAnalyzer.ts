 ...
 * 4. Estimate time signature (3/4 vs 4/4) from accent patterns
 * 5. Build beat grid from tempo + first beat + time signature
 * 6. Extract chroma features per beat
 * 7. Match chroma to chord templates (with diatonic boosting)
 * 8. Detect key from chord distribution
 * 9. Re-score chords with key-aware diatonic bias
 * 10. Smooth chord sequence with bar-level majority vote
 * 11. Absorb short anomalous chords
 */
